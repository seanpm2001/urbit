  ...
  ++  cool
    ...
    ?-  -.fid
      ...
      %&  =<  q
          ...
          ::TODO  this should work but doesn't. previous thing shouldn't work but does!
          ::TODO  need to reset the subject... changes in +mint and +play might be wrong
          t(p (~(put by p.t) l `[%fuse n &+a hyp]))
    ==
  ::
